namespace Ordering.Application.Orders.Commands.UdpateOrder;
     ...
     : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
{
    public async Task<UpdateOrderResult> Handle(UpdateOrderCommand command, CancellationToken cancellationToken)
    {
        ...
        UdpateOrderWithNewValues(order, command.Order);
    ...
    private void UdpateOrderWithNewValues(Order order, OrderDto orderDto)
    {
